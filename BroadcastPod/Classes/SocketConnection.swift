...
public class SocketConnection: NSObject {
    public var didOpen: (() -> Void)?
    public var didClose: ((Error?) -> Void)?
    public var streamHasSpaceAvailable: (() -> Void)?
   ...
   public func open() -> Bool {
    ...
    public  func writeToStream(buffer: UnsafePointer<UInt8>, maxLength length: Int) -> Int {
